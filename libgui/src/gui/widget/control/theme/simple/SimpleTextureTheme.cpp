...
namespace gui
{
   ...
   */
  SimpleTextureTheme::SimpleTextureTheme(Renderer& renderer, Texture const& texture, SimpleTextureThemeData const& data)
    : SimpleThemeBase(renderer, ControlThemeCreator<SimpleTextureControlTheme, SimpleTextureTheme>(*this)),
      texture_(&texture),
      pixel_data_(data)
  {
  }
