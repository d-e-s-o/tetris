...
#ifndef GUITESTMEMORYNAMESPACE_HPP
#define GUITESTMEMORYNAMESPACE_HPP
...
namespace test
{
  class TestMemoryNamespace: public tst::TestCase<TestMemoryNamespace>
  {
  public:
    TestMemoryNamespace();
