...
#ifndef BASEFILESTREAM_HPP
#define BASEFILESTREAM_HPP
...
{
  /**
   * This class is a specialized version of InputStream for files.
   */
  class LIBBASE_EXPORT FileStream: public RandomAccessStream
  {
  public:
    FileStream(char const* file, bool writeable = true, bool readable = true);
